...
class Practice extends Component {
    ...
    handleRomajiChange(sentence) {
        ...
        if (sentence.length < this.state.correctRomajiLength || !sentence.startsWith(this.state.typedRomajiSentence)) {
        ...
        } else if (!correctRomajiSyllable.startsWith(typedRomajiSyllable)) {
